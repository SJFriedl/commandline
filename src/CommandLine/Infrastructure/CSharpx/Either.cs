...
namespace CSharpx
{
    ...
    static class Either
    {
        ...
        {
            if (either.MatchRight(out var right)) {
                return func(right);
            }
        ...
        {
            return either.MatchLeft(out var value) ? value : @default;
        }
        ...
        {
            return either.MatchRight(out var value) ? value : @default;
        }
    ...
    static class EitherExtensions
    {
        ...
        {
            if (either.MatchLeft(out var left)) {
                ifLeft(left);
                return;
            }
